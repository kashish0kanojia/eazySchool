...
public class GlobalExceptionController {
    ...
    * */
    @ExceptionHandler(Exception.class)   //this is for the general exception(global scope)
//    @ExceptionHandler(NullPointerException.class) for specific exceptions we can make multiple methods with this
